...
country = {
	...
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.0,
	...
	COLONIZATION_COLONY_PROVINCE_MAINTAINANCE = 2,
	...
	COLONIZATION_COLONY_STATE_DISTANCE = 2000,
...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = 0.2, 		-- the lowest % the slider can go for constructions
...
military = {
	...
	SUPPLY_RANGE = 100,
	POP_MIN_SIZE_FOR_REGIMENT_PROTECTORATE_MULTIPLIER = 100,
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 100,
	...
	RECON_SIEGE_EFFECT = 0.75, -- multiplier to effect of recon on speeding up sieges
...
diplomacy = {
	...
	EXPELADVISORS_RELATION_ON_ACCEPT = -25,
	...
	BANEMBASSY_RELATION_ON_ACCEPT = -50,
	...
	REMOVEFROMSPHERE_RELATION_ON_ACCEPT = -50,
	...
	NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 1, -- Bonus to neighbouring countries when influencing
	SPHERE_NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.5, -- Bonus to countries in your sphere neighbouring when influencing
	...
	CB_DETECTION_CHANCE_BASE = 20, -- chance out of 1000 every day
	INVESTMENT_INFLUENCE_DEFENSE = 1,	-- maximum defense factor in sphere of having invested in a country
	RELATION_INFLUENCE_MODIFIER = 100, -- divisor for relation
	...
	RANK_1_TENSION_DECAY = -0.7, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.6,
	RANK_3_TENSION_DECAY = -0.5,
	RANK_4_TENSION_DECAY = -0.4,
	RANK_5_TENSION_DECAY = -0.2,
	RANK_6_TENSION_DECAY = -0.1,
	RANK_7_TENSION_DECAY = -0.05,
	RANK_8_TENSION_DECAY = -0.025,
...
pops = {
	...
	CONVERSION_SCALE = 0.004,
	IMMIGRATION_SCALE = 0.001,

	PROMOTION_SCALE = 0.002,
	PROMOTION_ASSIMILATION_CHANCE = 0.25,
	...
	LARGE_POPULATION_INFLUENCE_PENALTY_CHUNK = 100000,
},
...
ai = {
	...
	SOLDIER_FRACTION = 0.08, -- max amount of population AI wants to be soldiers
	...
	PEACE_FORCE_BALANCE_FACTOR = 0.6, -- AI willingness to peace based on strength estimation of both sides
...
graphics = {
	...
	CITIES_SIZE_MAX_POPULATION_K = 500 			-- When province population reach 1mln, the city will get it's maximum size.
}
